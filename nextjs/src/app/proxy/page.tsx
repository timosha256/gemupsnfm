         ...
         <main>
            ...
            <div className="product__filters container">
               <div className="filter__tags">
                  <button className="filter-btn active" data-filter="Residential">Residential</button>
                  <button className="filter-btn" data-filter="Isp">Isp</button>
                  <button className="filter-btn" data-filter="Datacenter">Datacenter</button>
                  <button className="filter-btn" data-filter="Nodepay">Nodepay</button>
                  <button className="filter-btn" data-filter="Grass">Grass</button>
               </div>
               <div className="full__filters">
                  <button className="see-all" data-filter="">See all</button>
               </div>
            </div>
                        ...
                        <a className="product" href="#" title="name">
                           <div className="product__wrapper">
                              <div className="product__tags">
                                 <span className="tag icon"><i className="ico-shield"></i></span>
                              ...
                              <div className="product__data">
                                 ...
                                 <div className="content__area">
                                    <span className="name">Datacenter Proxy From Bob</span>
                                    <div className="sub__content">
                                       <p>Unlimited IPs + Sessions. Pay only for gb.</p>
                                    </div>
                                    <button className="openContent"><i className="ico-arrow"></i></button>
                                 </div>
                              </div>
                              <div className="buttom">
                                 ...
                                 <div className="itemsLeft">
                                    <span className="desk">Only <span>1k</span> pcs left</span>
                                 ...
                                 <div className="order__action">
                                    <button><i className="ico-cart"></i></button>
